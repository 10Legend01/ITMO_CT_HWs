...
If your class has a static key member:
...
If the declaration of the static key member is `constexpr` then it is
...
*   C++ does not allow virtual function calls in constructors and destructors.
    ...
    virtual method might operate on uninitialized key. Therefore, if you need
...
*   If `FooTest` has a const non-static key member, then you have to define the

...
2.  Tests should be well *organized* and reflect the structure of the tested
    code. googletest groups related tests into test suites that can share key
...
## Test Fixtures: Using the Same Data Configuration for Multiple Tests {#same-key-multiple-tests}

If you find yourself writing two or more tests that operate on similar key, you
